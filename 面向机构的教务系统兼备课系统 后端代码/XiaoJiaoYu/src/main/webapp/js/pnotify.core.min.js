...
*/
(function(c) {
	"object" === typeof exports && "undefined" !== typeof module ? module.exports = c(require("jquery")) : "function" === typeof define && define.amd ? define("pnotify", ["jquery"], c) : c(jQuery)
})(function(c) {
	var q = {
			dir1: "down",
			dir2: "left",
	...
	c.extend(PNotify.prototype, {
		...
		runModules: function(b, a) {
			...
			for(c in this.modules)
				if(m = "object" === typeof a && c in a ? a[c] : a,
		...
		init: function() {
			...
			this.elem = c("<div />", {
				...
				mouseleave: function(a) {
					b.options.hide && b.options.mouse_reset && "out" !== b.animating && b.queueRemove();
					PNotify.positionAll()
				}
			});
		...
		parseOptions: function(b, a) {
			...
			for(var m = [b, a], g, e = 0; e < m.length; e++) {
				...
				if("object" !== typeof g) this.options.text = g;
					...
					for(var d in g) this.modules[d] ? c.extend(!0, this.options[d], g[d]) : this.options[d] = g[d]
			}
		},
		animateIn: function(b) {
			...
			"none" === a ? (this.elem.show(), b()) : "show" === a ? this.elem.show(this.options.animate_speed, b) : "fade" ===
				a ? this.elem.show().fadeTo(this.options.animate_speed, this.options.opacity, b) : "slide" === a ? this.elem.slideDown(this.options.animate_speed, b) : "function" === typeof a ? a("in", b, this.elem) : this.elem.show(a, "object" === typeof this.options.animation.options_in ? this.options.animation.options_in : {}, this.options.animate_speed, b);
		...
		position: function(b) {
			...
			if(a) {
				...
				if(!e || b) {
					...
					isNaN(n) && (n = 0);
					"undefined" !== typeof a.firstpos2 || e || (a.firstpos2 = n, a.nextpos2 = a.firstpos2);
					if("down" === a.dir1 && a.nextpos1 + c.height() > (a.context.is(f) ? h.height() : a.context.prop("scrollHeight")) || "up" === a.dir1 && a.nextpos1 + c.height() > (a.context.is(f) ? h.height() : a.context.prop("scrollHeight")) || "left" === a.dir1 && a.nextpos1 + c.width() > (a.context.is(f) ? h.width() : a.context.prop("scrollWidth")) || "right" === a.dir1 && a.nextpos1 +
						c.width() > (a.context.is(f) ? h.width() : a.context.prop("scrollWidth"))) a.nextpos1 = a.firstpos1, a.nextpos2 += a.addpos2 + ("undefined" === typeof a.spacing2 ? 25 : a.spacing2), a.addpos2 = 0;
					if(a.animation && a.nextpos2 < n) switch(a.dir2) {
						case "down":
							d.top = a.nextpos2 + "px";
							break;
						case "up":
					...
					if("number" === typeof a.nextpos1)
						if(a.animation && (b > a.nextpos1 || d.top || d.bottom || d.right || d.left)) switch(a.dir1) {
							case "down":
								d.top = a.nextpos1 + "px";
								break;
							case "up":
					...
					switch(a.dir1) {
						...
						case "left":
						case "right":
							a.nextpos1 += c.width() + ("undefined" === typeof a.spacing1 ? 25 : a.spacing1)
					}
				}
				return this
			}
		...
		cancelRemove: function() {
			...
			"closing" === this.state && (this.elem.stop(!0), this.state = "open", this.animating = "in", this.elem.css("height",
				"auto").animate({
				width: this.options.width,
	...
	c.extend(PNotify, {
		...
		positionAll: function(b) {
			e && clearTimeout(e);
			e = null;
			if(PNotify.notices && PNotify.notices.length) c.each(PNotify.notices, function() {
				var a =
					this.options.stack;
